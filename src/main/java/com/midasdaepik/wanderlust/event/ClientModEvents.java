...
public class ClientModEvents {
    ...
    public static void onRegisterClientExtensionsEvent(RegisterClientExtensionsEvent pEvent) {
        ...
        pEvent.registerItem(
                new IClientItemExtensions() {
                    public HumanoidModel.ArmPose getArmPose(LivingEntity pLivingEntity, InteractionHand pHand, ItemStack pItemStack) {
                        return pLivingEntity.isUsingItem() ? HumanoidModel.ArmPose.CROSSBOW_HOLD : HumanoidModel.ArmPose.CROSSBOW_CHARGE;
                    }
                },
                WLItems.OBSIDIAN_BULWARK.get()
        );
        ...
        pEvent.registerItem(
                new IClientItemExtensions() {
                    public HumanoidModel.ArmPose getArmPose(LivingEntity pLivingEntity, InteractionHand pHand, ItemStack pItemStack) {
                        return pLivingEntity.isUsingItem() ? HumanoidModel.ArmPose.CROSSBOW_HOLD : HumanoidModel.ArmPose.ITEM;
                    }
                },
                WLItems.SONIC_ARPEGGIO.get()
        );
    }
}
